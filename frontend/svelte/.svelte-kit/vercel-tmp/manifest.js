	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/upload-queue/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/upload-queue/recent/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/upload-queue/status/_server.ts.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/upload-queue/status/_jobId_/_server.ts.js'))
			},
			{
				id: "/auto-login",
				pattern: /^\/auto-login\/?$/,
