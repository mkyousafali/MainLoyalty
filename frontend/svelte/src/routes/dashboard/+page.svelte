...
<main class="p-6 max-w-6xl mx-auto mt-8">
  ...
  {:else if customerData}
    <!-- Main Widgets - 2 Column Grid with Enhanced Spacing -->
    <div class="grid md:grid-cols-2 gap-8">
      <!-- Points Widget with Premium Brand Design -->
      <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300" style="box-shadow: 0 4px 20px rgba(240, 131, 0, 0.1);">
        
        <!-- Futuristic Points Display -->
        <div class="text-center mb-8">
          <div class="flex items-center justify-center gap-8 mb-8">
            <!-- Current Points - Futuristic Card -->
            <div class="relative group">
              ...
              <!-- Main card -->
              <div class="relative w-36 h-44 rounded-2xl overflow-hidden" style="background: linear-gradient(135deg, rgba(19, 165, 56, 0.9) 0%, rgba(119, 171, 57, 0.9) 100%); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2);">
                ...
                <div class="absolute top-0 left-0 w-6 h-6 border-t-2 border-l-2 border-white opacity-50"></div>
                <div class="absolute top-0 right-0 w-6 h-6 border-t-2 border-r-2 border-white opacity-50"></div>
                <div class="absolute bottom-0 left-0 w-6 h-6 border-b-2 border-l-2 border-white opacity-50"></div>
                <div class="absolute bottom-0 right-0 w-6 h-6 border-b-2 border-r-2 border-white opacity-50"></div>
                
                <!-- Content -->
                <div class="relative z-10 h-full flex flex-col justify-center items-center p-4">
                  <!-- LED-style indicator -->
                  <div class="w-2 h-2 rounded-full bg-cyan-400 shadow-lg animate-pulse mb-2" style="box-shadow: 0 0 10px #00ffff;"></div>
                  
                  <!-- Number display -->
                  <div class="text-3xl font-bold text-white mb-2 font-mono tracking-wider" style="text-shadow: 0 0 20px rgba(255,255,255,0.5), 0 0 10px rgba(19,165,56,0.8);">
                    {isLoading ? '...' : currentBalance.toFixed(2)}
                  </div>
                  
                  <!-- Label with futuristic styling -->
                  <div class="text-xs text-white uppercase tracking-widest font-bold opacity-90 px-2 py-1 rounded border border-white border-opacity-30" style="background: rgba(255,255,255,0.1); text-shadow: 0 0 10px rgba(255,255,255,0.8);">
            ...
            <!-- Lifetime Points - Futuristic Card -->
            <div class="relative group">
              <!-- Animated background glow -->
              ...
              <!-- Main card -->
              <div class="relative w-36 h-44 rounded-2xl overflow-hidden" style="background: linear-gradient(135deg, rgba(240, 131, 0, 0.9) 0%, rgba(255, 149, 0, 0.9) 100%); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2);">
                <!-- Holographic grid pattern -->
                <div class="absolute inset-0 opacity-10" style="background-image: repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(255,255,255,0.1) 2px, rgba(255,255,255,0.1) 4px), repeating-linear-gradient(90deg, transparent, transparent 2px, rgba(255,255,255,0.1) 2px, rgba(255,255,255,0.1) 4px);"></div>
                ...
                <div class="relative z-10 h-full flex flex-col justify-center items-center p-4">
                  <!-- LED-style indicator -->
                  <div class="w-2 h-2 rounded-full bg-yellow-400 shadow-lg animate-pulse mb-2" style="box-shadow: 0 0 10px #ffff00;"></div>
                  
                  <!-- Number display -->
                  <div class="text-3xl font-bold text-white mb-2 font-mono tracking-wider" style="text-shadow: 0 0 20px rgba(255,255,255,0.5), 0 0 10px rgba(240,131,0,0.8);">
          ...
          <div class="grid grid-cols-2 gap-6 text-center">
            <div class="relative group">
              ...
              <!-- Card content -->
              <div class="relative p-4 rounded-xl border border-emerald-500 border-opacity-30" style="background: linear-gradient(135deg, rgba(19, 165, 56, 0.1) 0%, rgba(119, 171, 57, 0.1) 100%); backdrop-filter: blur(5px);">
                <!-- LED indicator -->
                <div class="w-1.5 h-1.5 rounded-full bg-emerald-400 mx-auto mb-2 animate-pulse" style="box-shadow: 0 0 8px #10b981;"></div>
                
                <h3 class="text-lg font-bold mb-2" style="color: #13A538; text-shadow: 0 0 10px rgba(19, 165, 56, 0.5);">
                  {$t.yourBalance}
                </h3>
                <p class="text-gray-600 text-sm font-mono opacity-80">
                  {selectedBranch === 'all' ? 
                    $t.totalAvailable : 
                    ($language === 'ar' ? 
            ...
            <div class="relative group">
              ...
              <!-- Card content -->
              <div class="relative p-4 rounded-xl border border-orange-500 border-opacity-30" style="background: linear-gradient(135deg, rgba(240, 131, 0, 0.1) 0%, rgba(255, 149, 0, 0.1) 100%); backdrop-filter: blur(5px);">
                <!-- LED indicator -->
                <div class="w-1.5 h-1.5 rounded-full bg-orange-400 mx-auto mb-2 animate-pulse" style="box-shadow: 0 0 8px #f97316;"></div>
                
                <h3 class="text-lg font-bold mb-2" style="color: #f08300; text-shadow: 0 0 10px rgba(240, 131, 0, 0.5);">
                  {$t.lifetimeEarned}
                </h3>
                <p class="text-gray-600 text-sm font-mono opacity-80">
                  {selectedBranch === 'all' ? 
        ...
        <!-- Branch Filter -->
        <label for="branch-select" class="text-sm font-bold uppercase tracking-wide mb-3 block" style="color: #13A538;" class:text-right={$language === 'ar'}>{$t.filterTransactions}</label>
        <select 
          id="branch-select" 
          bind:value={selectedBranch} 
          class="px-4 py-3 border-2 border-gray-200 rounded-xl w-full bg-white mt-2 focus:ring-2 focus:border-transparent transition-all shadow-sm hover:border-gray-300" 
        ...
        <p class="text-xs text-gray-500 mt-2" class:text-right={$language === 'ar'}>
          {$t.filterNote}
        </p>
      </div>
      ...
      <div class="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
        <h3 class="text-2xl font-bold mb-6 text-center" style="color: #13A538;">
          {$t.quickActions}
        </h3>
        ...
        <div class="space-y-4">
          ...
          <a href="/virtual-card" class="block">
            <div class="flex items-center gap-4 p-4 rounded-xl transition-all duration-300 hover:shadow-md transform hover:scale-[1.02] cursor-pointer" style="background: linear-gradient(135deg, #f08300 0%, #ff9500 100%); color: white;">
              <div class="text-3xl">💳</div>
              <div class="flex-1">
                <h4 class="font-bold text-lg">{$t.virtualCard}</h4>
                <p class="text-orange-100 text-sm">{$t.viewYourCard}</p>
              </div>
          ...
          <a href="/customer-support" class="block">
            <div class="flex items-center gap-4 p-4 rounded-xl transition-all duration-300 hover:shadow-md transform hover:scale-[1.02] cursor-pointer" style="background: linear-gradient(135deg, #13A538 0%, #77AB39 100%); color: white;" class:flex-row-reverse={$language === 'ar'}>
              <div class="text-3xl">💬</div>
              <div class="flex-1">
                <h4 class="font-bold text-lg">{$t.customerSupport}</h4>
                <p class="text-green-100 text-sm">{$t.needHelp}</p>
              </div>
              <div class="text-2xl opacity-70">→</div>
            </div>
          </a>
          ...
          <a href="/my-offers" class="block">
            <div class="flex items-center gap-4 p-4 rounded-xl transition-all duration-300 hover:shadow-md transform hover:scale-[1.02] cursor-pointer" style="background: linear-gradient(135deg, #C0A32A 0%, #D4B836 100%); color: white;" class:flex-row-reverse={$language === 'ar'}>
              <div class="text-3xl">🎁</div>
              <div class="flex-1">
                <h4 class="font-bold text-lg">{$t.myOffers}</h4>
                <p class="text-yellow-100 text-sm">{$t.viewSpecialOffers}</p>
              </div>
              <div class="text-2xl opacity-70">→</div>
            </div>
          </a>
    ...
    <!-- Recent Transactions Section - Futuristic Design -->
    <section class="relative mt-8">
      ...
      <div class="relative bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden" style="backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2);">
        ...
        <div class="relative p-8 pb-6" style="background: linear-gradient(135deg, rgba(19, 165, 56, 0.05) 0%, rgba(119, 171, 57, 0.05) 100%);">
          ...
          <div class="relative flex justify-between items-center">
            <div class="flex items-center gap-4">
              <!-- LED indicator -->
              <div class="w-3 h-3 rounded-full bg-emerald-400 animate-pulse" style="box-shadow: 0 0 15px #10b981;"></div>
              
              <h3 class="text-3xl font-bold font-mono tracking-wide" style="color: #13A538; text-shadow: 0 0 20px rgba(19, 165, 56, 0.3);">
            ...
            <div class="space-y-4">
              {#each filteredTransactions as tx}
                ...
                <div class="relative group">
                  ...
                  <!-- Card content -->
                  <div class="relative p-6 rounded-2xl border border-gray-200 transition-all duration-300 group-hover:border-emerald-300" style="background: linear-gradient(135deg, rgba(255, 255, 255, 0.9) 0%, rgba(249, 250, 251, 0.9) 100%); backdrop-filter: blur(5px);">
                    
                    <!-- Corner accents -->
                    <div class="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-emerald-400 opacity-30"></div>
                    <div class="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-emerald-400 opacity-30"></div>
                    ...
                    <div class="grid grid-cols-3 gap-6 items-center">
                      ...
                      <div class="flex items-center gap-3">
                        <!-- Date icon -->
                        <div class="w-10 h-10 rounded-xl flex items-center justify-center" style="background: linear-gradient(135deg, #C0A32A 0%, #D4B836 100%);">
                          <span class="text-white text-lg font-bold">📅</span>
                        </div>
                        
                        <div>
                          <div class="font-mono text-gray-800 font-semibold">
                      ...
                      <div class="flex items-center gap-3">
                        <!-- Branch icon -->
                        <div class="w-10 h-10 rounded-xl flex items-center justify-center" style="background: linear-gradient(135deg, #13A538 0%, #77AB39 100%);">
                          <span class="text-white text-lg font-bold">🏪</span>
                        </div>
                      ...
                      <div class="flex items-center gap-3 justify-end">
                        <div class="text-right">
                          <div class="text-2xl font-bold font-mono currency-display" style="color: #f08300; text-shadow: 0 0 10px rgba(240, 131, 0, 0.3);">
          ...
          {:else}
            ...
            <div class="text-center py-16">
              ...
              <div class="relative">
                ...
                <!-- Content -->
                <div class="relative p-8 rounded-3xl" style="background: linear-gradient(135deg, rgba(243, 244, 246, 0.5) 0%, rgba(249, 250, 251, 0.8) 100%); backdrop-filter: blur(5px); border: 1px solid rgba(156, 163, 175, 0.2);">
                  
                  <!-- Large icon with animation -->
                  <div class="w-24 h-24 mx-auto mb-6 rounded-full flex items-center justify-center animate-pulse" style="background: linear-gradient(135deg, #6B7280 0%, #9CA3AF 100%);">
                    <span class="text-4xl">📋</span>
                  </div>
                  
                  <!-- Main message -->
                  <h4 class="text-2xl font-bold text-gray-700 mb-3 font-mono">
    ...
    <!-- Point Redemption Conditions Section -->
    <section class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 mt-8">
      <div class="flex items-center gap-3 mb-6">
        <div class="w-12 h-12 rounded-full flex items-center justify-center" style="background: linear-gradient(135deg, #C0A32A 0%, #D4B836 100%);">
          <span class="text-2xl">🎯</span>
        </div>
        <div>
          <h3 class="text-2xl font-bold" style="color: #C0A32A;">
      ...
      <div class="grid md:grid-cols-2 gap-6">
        <!-- Redemption Values -->
        <div class="space-y-4">
          <h4 class="font-bold text-lg" style="color: #13A538;">
            {$t.allowedRedemptions || 'Allowed Redemption Values'}
          </h4>
          <div class="grid grid-cols-2 gap-3">
            {#each [50, 100, 150, 200] as points}
              <div class="flex items-center justify-between p-3 rounded-lg border-2" style="border-color: #77AB39; background: #F3FFF8;">
                <span class="font-bold text-lg" style="color: #13A538;">{points}</span>
                <span class="text-sm text-gray-600">{$t.points || 'Points'}</span>
              </div>
            {/each}
          </div>
        </div>
        ...
        <!-- Important Rules -->
        <div class="space-y-4">
          <h4 class="font-bold text-lg" style="color: #f08300;">
            {$t.importantRules || 'Important Rules'}
          </h4>
          <div class="space-y-3">
            <div class="flex items-start gap-3 p-3 rounded-lg" style="background: #FFF8F0; border: 1px solid #f08300;">
            ...
            <div class="flex items-start gap-3 p-3 rounded-lg" style="background: #F3FFF8; border: 1px solid #77AB39;">
              <span class="text-lg">✅</span>
              <div class="flex-1 text-sm">
                <p class="font-medium text-gray-800">
      ...
      <!-- Contact Support for Redemption -->
      <div class="mt-6 p-4 rounded-xl text-center" style="background: linear-gradient(135deg, #EAFBEF 0%, #F3FFF8 100%); border: 2px solid #77AB39;">
        ...
        <a href="/customer-support" class="inline-flex items-center gap-2 text-white px-6 py-3 rounded-xl font-bold transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl" style="background: #13A538;">
