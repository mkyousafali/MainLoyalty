...
export const CSS_VARIABLES = {
  ...
  '--font-family-sans': THEME_CONFIG.typography.fontFamily.sans.join(', '),
  '--font-family-arabic': THEME_CONFIG.typography.fontFamily.arabic.join(', '),
  '--border-radius': THEME_CONFIG.borderRadius.md,
  '--animation-duration': THEME_CONFIG.animation.normal
} as const;
