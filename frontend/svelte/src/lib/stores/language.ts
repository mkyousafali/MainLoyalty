...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    discoverAmazingDeals: 'Discover amazing visual deals with exclusive images and detailed offer information',
    searchOffers: 'Search offers...',
    allOffers: 'All Offers',
    availableOffers: 'Available Offers',
    locations: 'Locations',
    loadingExclusiveOffers: 'Loading your exclusive offers...',
    unableToLoadOffers: 'Unable to Load Offers',
    noOffersFound: 'No offers found',
    tryAdjustingFilters: 'Try adjusting your search terms or branch filter',
    ...
    thisOfferNoLongerAvailable: 'This offer is no longer available',
  ...
  ar: {
    ...
    discoverAmazingDeals: 'اكتشف عروضاً مرئية مذهلة مع صور حصرية ومعلومات مفصلة عن العروض',
    searchOffers: 'البحث في العروض...',
    allOffers: 'جميع العروض',
    availableOffers: 'العروض المتاحة',
    locations: 'المواقع',
    loadingExclusiveOffers: 'جاري تحميل عروضك الحصرية...',
    unableToLoadOffers: 'تعذر تحميل العروض',
    noOffersFound: 'لا توجد عروض',
    tryAdjustingFilters: 'حاول تعديل مصطلحات البحث أو تصفية الفروع',
    ...
    validUntil: 'صالح حتى:',
    expiredOn: 'انتهت في:',
    thisOfferNoLongerAvailable: 'هذا العرض لم يعد متاحاً',
    offerExpired: 'انتهى العرض',
    noLongerAvailable: 'لم يعد متاحاً',
    downloadFullOfferDetails: 'تحميل تفاصيل العرض كاملة',
    noAdditionalDetailsAvailable: 'لا توجد تفاصيل إضافية متاحة',
