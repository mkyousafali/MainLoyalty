import { P as ensure_array_like, T as head, K as escape_html, I as attr, G as attr_class, D as pop, z as push } from "../../../../chunks/index.js";
...
5.3 الامتثال: يجب على المستخدمين الامتثال لجميع القوانين المعمول بها، بما في ذلك على سبيل المثال لا الحصر القانون التجاري السعودي ولوائح حماية المستهلك ومتطلبات مكافحة غسل الأموال.`
  ...
  const each_array = ensure_array_like(Object.entries(termsContent[currentLang].sections));
  head($$payload, ($$payload2) => {
    $$payload2.title = `<title>Terms &amp; Conditions Management - Admin Panel</title>`;
  });
  $$payload.out.push(`<div class="terms-management svelte-1cgvump"><div class="header svelte-1cgvump"><div class="header-content svelte-1cgvump"><div class="header-left svelte-1cgvump"><h1 class="svelte-1cgvump">Terms &amp; Conditions Management</h1> <p class="header-subtitle svelte-1cgvump">Edit and manage the Terms &amp; Conditions for the loyalty program</p></div> <div class="header-actions svelte-1cgvump"><button class="language-toggle svelte-1cgvump" title="Switch Language"><span class="icon">🌐</span> <span>${escape_html("العربية")}</span></button> <button class="preview-button svelte-1cgvump" title="Preview Terms"><span class="icon">👁️</span> <span>Preview</span></button> <button class="save-button svelte-1cgvump"${attr("disabled", isLoading, true)} title="Save Changes">`);
  {
    $$payload.out.push("<!--[!-->");
    $$payload.out.push(`<span class="icon">💾</span> <span>Save Changes</span>`);
  }
  ...
  $$payload.out.push(`<!--]--> <div${attr_class("content-editor svelte-1cgvump", void 0, { "rtl": currentLang === "ar" })}><div class="editor-header svelte-1cgvump"><h2>${escape_html(termsContent[currentLang].title)}</h2> <input type="text" class="title-input svelte-1cgvump"${attr("value", termsContent[currentLang].title)} placeholder="Document Title"/> <input type="text" class="subtitle-input svelte-1cgvump"${attr("value", termsContent[currentLang].subtitle)} placeholder="Document Subtitle"/></div> <div class="sections-editor svelte-1cgvump"><!--[-->`);
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
    let [sectionKey, section] = each_array[$$index];
    $$payload.out.push(`<div class="section-editor svelte-1cgvump"><div class="section-header"><input type="text" class="section-title-input svelte-1cgvump"${attr("value", section.title)} placeholder="Section Title"/></div> <div class="section-content"><textarea class="content-textarea svelte-1cgvump" placeholder="Section Content" rows="15">`);
    const $$body = escape_html(section.content);
    if ($$body) {
      $$payload.out.push(`${$$body}`);
    }
    $$payload.out.push(`</textarea></div></div>`);
  }
  $$payload.out.push(`<!--]--></div> <div class="add-section svelte-1cgvump"><button class="add-section-button svelte-1cgvump"><span class="icon">➕</span> <span>Add New Section</span></button></div></div> <div class="footer-info svelte-1cgvump"><div class="info-card svelte-1cgvump"><h3 class="svelte-1cgvump">💡 Tips for Editing</h3> <ul class="svelte-1cgvump"><li class="svelte-1cgvump">Use bullet points (•) for lists</li> <li class="svelte-1cgvump">Ensure both English and Arabic versions are updated</li> <li class="svelte-1cgvump">Preview changes before saving</li> <li class="svelte-1cgvump">Save regularly to avoid losing changes</li></ul></div> <div class="info-card svelte-1cgvump"><h3 class="svelte-1cgvump">📢 Customer Notifications</h3> <p class="svelte-1cgvump">When you save changes, customers will automatically receive a notification about the Terms &amp; Conditions update.</p></div></div></div>`);
  pop();
}
export {
  _page as default
